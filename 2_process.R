...
p2_targets <- list(
  ...
  tar_target(p2_aquifer_name_xwalk,
             tibble::tribble(
               ...
               "cacb", 0.1,0.6,       "CA Coastal Basin",       1, 4, 1,
               "cval", 0.1,0.34,       "Central Valley",                 2, 3, 1,
               "clpt", 0.1,0.88,        "Columbia Plateau\nbasaltic-rock", 3, 1, 1,
               "bnrf", 0.27,0.33,       "Basin & Range\nbasin-fill",     4, 4, 3,
               "bnrc", 0.25,0.63,       "Basin & Range\ncarbonate-rock", 5, 3, 2,
               "copl", 0.38,0.48,       "Colorado Plateau",           6, 3, 4,
               "hpaq", 0.5,0.62,        "High Plains",                7, 3, 5,
               "strv1", 0.62,0.58,      "Stream Valley-\nWest",         8, 3, 6,
               "rgaq", 0.45,0.42,       "Rio Grande",                 9, 4, 4,
               "edtr", 0.39,0.28,       "Edwards-\nTrinity",            10, 5, 5,
               "ozrk", 0.58,0.46,       "Ozarks",                     13, 4, 7,
               "metx", 0.35,0.13,       "MS Embayment &\nTX coastal uplands", 14, 6, 5,
               "secp", 0.88,0.4,       "Southeastern\nCoastal Plain",   15, 4, 9,
               "strv2", 0.73,0.62,      "Stream Valley-\nEast",           16, 2, 9,
               "cmor",  0.7,0.72,      "Cambrian-\nOrdovician",          17, 2, 7,
               "glac",  0.5,0.85,      "Glacial",                      18, 1, 6,
               "vpdc",  0.88,0.75,      "Valley &\nRidge", 19, 2, 10,
               "pied",  0.73,0.52,      "Piedmont", 20, 3, 9,
               "nacp",  0.93,0.48,      "N Atlantic\nCoastal Plain", 21, 3, 10,
               "surf",  0.88,0.3,      "Surficial",                22, 5, 9, 
               "bisc",  0.88,0.13,      "Biscayne",                   23, 6, 9,
               "flor",  0.7,0.35,      "Floridian",                   24, 5, 8,
