...
p2_targets <- list(
  ...
  tar_target(p2_aquifer_name_xwalk,
             tibble::tribble(
               ...
               "bnrf",        "Basin and Range basin-fill",     4, 4, 3,
               "bnrc",        "Basin and Range carbonate-rock", 5, 3, 2,
               "copl",        "Colorado Plateau",           6, 3, 4,
               "hpaq",        "High Plains",                7, 3, 5,
               "strv1",       "Stream Valley-West",         8, 3, 6,
               "rgaq",        "Rio Grande",                 9, 4, 4,
               "edtr",        "Edwards-Trinity",            10, 5, 5,
               "ozrk",        "Ozarks",                     13, 4, 7,
               "metx",        "Mississippi Embayment and Texas coastal uplands", 14, 6, 5,
               "secp",        "Southeastern Coastal Plain",   15, 4, 9,
               "strv2",       "Stream Valley-East",           16, 2, 9,
               "cmor",        "Cambrian-Ordovician",          17, 2, 7,
               "glac",        "Glacial",                      18, 2, 6,
               "vpdc",         "Valley and Ridge, Piedmont and Blue Ridge", 19, 2, 10,
               "pied",        "Piedmont and Blue Ridge crystalline", 20, 3, 9,
               "nacp",        "Northern Atlantic Coastal Plain", 21, 3, 10,
               "surf",          "Surficial",                22, 5, 9, 
               "bisc",        "Biscayne",                   23, 6, 9,
               "flor",        "Floridian",                   24, 5, 8,
               "clow",        "Coastal Lowlands",           25, 5, 7
             )),
