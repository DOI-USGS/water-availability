...
p3_targets <- list(
  ...
  tar_target(p3_aquifer_basemap_png,
           aquifer_map(in_sf = p1_aquifers_sf,
                       ...
                       width = 9, height = 6),
           format = "file"),
  tar_target(p3_wq_gw_geofacet_arsenic_png,
             wq_geofacet_nobase(in_df = p1_wq_constituent_exceedences_df |> 
                                  filter(parameter == "arsenic"),
                                in_states = p2_State_detailed_sf,
                                in_sf = p1_aquifers_sf,
                                in_geogrid = p2_aquifer_name_xwalk,
                                aquifer_abbr = "overview",
                                color_scheme = p3_colors_wq,
                                png_out = "src/assets/images/R/06_wq_arsenic.png",
                                width = 9, height = 6
             ),
             format = "file"),
