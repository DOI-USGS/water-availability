...
p3_targets <- list(
  ...
  tar_map(
    ...
    tar_target(p3_ws_cascading_2010_png,
               plot_deviations(data_in = p2_ws_all_df,
                               region = reg,
                               png_out = sprintf("src/assets/images/R/04_ws_2010_%s.png", reg_noSpace),
                               width = 3, height = 5,
  ...
  tar_target(p3_wu_ir_HUC12_map_png,
             map_ir_or_ps(in_sf = p2_HUC12_join_wu_sf,
                          layer = "ir",
                          in_regions = p2_Reg_sf,
                          color_scheme = p3_colors_wu,
                          #png_out = "src/assets/images/R/08_wu_ir_map.png",
                          png_out = '3_visualize/out/08_wu_ir_map.png',
                          width = 8, height = 6)),
  tar_target(p3_wu_ps_HUC12_map_png,
             map_ir_or_ps(in_sf = p2_HUC12_join_wu_sf,
                          ...
                          png_out = '3_visualize/out/08_wu_ps_map.png',
                          width = 8, height = 6)),
  tar_target(p3_wu_te_HUC12_fresh_map_png,
             map_te(in_sf = p2_HUC12_join_wu_sf,
                    layer = "fresh",
                    in_regions = p2_Reg_sf,
                    color_scheme = p3_colors_wu,
                    #png_out = "src/assets/images/R/08_wu_te_fresh_map.png",
                    png_out = '3_visualize/out/08_wu_te_fresh_map.png',
                    width = 8, height = 6)),
  tar_target(p3_wu_te_HUC12_saline_map_png,
             map_te(in_sf = p2_HUC12_join_wu_sf,
                    layer = "saline",
                    in_regions = p2_Reg_sf,
                    color_scheme = p3_colors_wu,
                    #png_out = "src/assets/images/R/08_wu_te_saline_map.png",
                    png_out = '3_visualize/out/08_wu_te_saline_map.png',
                    width = 8, height = 6)),
