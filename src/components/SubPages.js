            ...
            tabData: [
                {
                    ...
                    tabText: "Groundwater-derived drinking water can be affected by high concentrations of constituents from geologic sources, including arsenic, manganese, and lithium, as well as salinity and nitrogen. Mixtures of multiple groundwater contaminants can also have compounding effects, because different users may have elevated sensitivity when exposed to multiple water-quality issues at once (Kaushal et al., 2018; Waite et al., 2019, 2021). Threats to human health, corrosion of infrastructure, reduced crop yields, poor taste, impeded navigation, and economic impacts can all result from poor water quality (Erickson et al., 2025). Areas with the most limited groundwater quality include the Southern High Plains and the Southwest Desert regions."
                },{
                    tabTitle: "Ecoflows",
                    tabSubtitle: "Water availability for ecosystems is limited by altered natural flows",
                    tabTitleID: "eco",
                    tabTitleIDname: "ecoflow",
                    tabText: "Humans alter the natural flow of water by building water management structures, such as reservoirs, impoundments, and diversions, and by covering land with impervious surfaces. These structures can affect the flow regime through water storage and releases, potentially altering the timing, seasonality, frequency, and rate of change of flows (Kennedy et al., 2016; Eng et al., 2019; Moreira et al., 2019), even if total flow volume remains equivalent. Areas with the most impacted ecosystem flows are the Northeast, Central High Plains, Texas, and Florida regions."
                },
            ]
        },
        {
