    ...
    <section class="main-container">
        ...
        <div class="caption-container">
          <b>Water limitation:</b> 
              ...
              <br/>
              <div class="caption-text-child">
                <p>Water limitation across the lower 48, shown as the average from 2010 to 2020 for each watershed (HUC12). The bar chart shows the proportion of each water limitation category. When hydrologic regions are selected on the map the bar chart reflects water limitation for that region.<span v-for="reference in theseReferences.filter(item => item.refID === 'VanMetre2020')" class="tooltip"> <sup class="in-text-number">{{ reference.referenceNumber }} </sup> <span class="tooltiptext"> {{ reference.label }}</span></span></p>
              </div>
        </div>    
        ...
        <div class="caption-container">
          <div class="caption-text-child">
            <p>Water limitation across the lower 48 United States by month from January 2010 through January 2020. The bars show the proportion of each water limitation category.</p>
          </div>
        </div>  
        <Methods></Methods>
