<template>
    <section class="main-container">
        ...
        <div class="content-container">
            ...
            <div class="viz-container">
                <img class="viz-double-portrait" src="https://labs.waterdata.usgs.gov/visualizations/images/water-availability/04_Prec.png">
                <img class="viz-double-portrait" src="https://labs.waterdata.usgs.gov/visualizations/images/water-availability/04_noPrec.png">
            </div>
            <div class="text-container">
