        ...
        <div class="content-container">
            <div class="text-container">
                ...
                <div class="viz-container">
                    <img class="viz-placeholder" src="@/assets/images/k01_sankey.png">
                </div>
                <div class="text-container">
            ...
            <div class="viz-container">
                <img class="viz-double-portrait" src="../../public/images/A.png">
                <img class="viz-double-portrait" src="../../public/images/B.png">
            </div>
            <div class="text-container">
