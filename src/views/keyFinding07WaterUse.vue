  ...
  <section class="main-container">
    ...
    <div class="content-container">
      ...
      <div class="chart-title-container">
            <h4 class="chart-title">Average daily water use from 2010 to 2020</h4>
            <p class="chart-subtitle" aria-hidden="true">Millions of gallons used per day by use type</p>
        <!-- Scale toggle -->
        <ToggleSwitch 
          v-model="isFaceted"
          leftLabel="Total use"
