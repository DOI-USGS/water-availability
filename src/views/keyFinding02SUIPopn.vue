          ...
          <div class="text-container">
            ...
            <div class="availability-container">
              <div class="wa-map-text-container" id="sui-map">
                ...
                <img class="wa-map" :src="`${s3ProdURL}images/water-availability/02_water_avail_wa_sui.png`" alt="Map showing areas of the lower 48 states with relatively high water limitation, including the Mississippi Embayment, Texas, and Southern and Central high plains regions.">
              </div>
              <div class="wa-map-text-container" id="sw-map">
                ...
                <img class="wa-map" :src="`${s3ProdURL}images/water-availability/02_water_avail_wa_sw_wq.png`" alt="Map showing areas of the lower 48 states with relatively low surface water quality, including the high plains, midwest, and souris-red-rainy regions.">
              </div>
              <div class="wa-map-text-container" id="gw-map">
                ...
                <img class="wa-map" :src="`${s3ProdURL}images/water-availability/02_water_avail_wa_gw_wq.png`" alt="Map showing areas of the lower 48 states with relatively poor groundwater quality, including the southern high plains and the southwest desert regions.">
              </div>
