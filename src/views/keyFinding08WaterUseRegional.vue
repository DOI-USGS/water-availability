    ...
    <section class="main-container">
        ...
        <div class="content-container">
          ...
          <div class="text-container">
            ...
            <br><br>
            <p>This data visualization shows the relative amount of water withdrawn for public supply that comes from groundwater or surface water by region. The bars are placed from west to east based on the longitude (easting) of the center of each hydrologic region. Hover over the map to see each individual region's data.</p>
          </div>
          <div class="viz-container">
