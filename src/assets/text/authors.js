export default {
    leads: [
        {
          ...
          headshot: 'https://labs.waterdata.usgs.gov/visualizations/headshots/aaarcher_staff_profile.jpg'
        },
        {
          ...
          headshot: 'https://labs.waterdata.usgs.gov/visualizations/headshots/mandiecarr_oct2022.JPG'
        },
        {
          fullName: 'Cee Nell',
          initials: 'CN',
    ...
    devs: [
        ...
        profile_link: 'https://www.usgs.gov/staff-profiles/hayley-corson-dosch',
          headshot: 'https://labs.waterdata.usgs.gov/visualizations/headshots/HCorson-Dosch.png'
        },
        {
        ...
        profile_link: 'https://www.usgs.gov/staff-profiles/margaret-maggie-jaenicke',
          headshot: 'https://labs.waterdata.usgs.gov/visualizations/headshots/MaggieJaenicke.png'
        },
        {
